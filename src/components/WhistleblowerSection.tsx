              ...
              >
                <div>
                  ...
                  <select
                    id="category"
                    required
                    className="w-full rounded-sm border border-stone bg-pearl-light px-4 py-3 text-sm text-charcoal outline-none transition-colors focus:border-gold"
                    defaultValue=""
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-sm border border-stone bg-pearl-light px-4 py-3 text-sm text-charcoal outline-none transition-colors placeholder:text-muted/40 focus:border-gold"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full resize-y rounded-sm border border-stone bg-pearl-light px-4 py-3 text-sm text-charcoal outline-none transition-colors placeholder:text-muted/40 focus:border-gold"
                  />
                </div>
