...
export default function HighlightSection({
  ...
  return (
    <>
      {/* MOBILE */}
      <section className="relative flex h-[60vh] min-h-[400px] items-center justify-center overflow-hidden md:hidden">
        ...
        >
          <svg width="32" height="22" viewBox="0 0 40 28" fill="none" className="mx-auto mb-5 text-gold/50">
          ...
          <p className="font-display text-xl leading-snug text-charcoal">
            &ldquo;{quote}&rdquo;
          </p>
          {attribution && (
            <p className="mt-5 text-xs font-medium uppercase tracking-[0.25em] text-gold-dark">
              &mdash; {attribution}
            </p>
          )}
        </motion.div>
