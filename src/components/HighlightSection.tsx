...
export default function HighlightSection({
  ...
  return (
    <>
      {/* MOBILE */}
      <section className="relative flex items-center justify-center md:hidden">
        <img
        ...
        >
          <svg width="28" height="20" viewBox="0 0 40 28" fill="none" className="mb-4 text-gold/50 shrink-0">
          ...
          <p className="font-display text-lg leading-snug text-white max-w-md">
            &ldquo;{quote}&rdquo;
          </p>
          {attribution && (
            <p className="mt-4 text-[10px] font-medium uppercase tracking-[0.25em] text-gold shrink-0">
              &mdash; {attribution}
            </p>
          )}
        </motion.div>
