...
function StatCard({ stat, index }: { stat: StatItem; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group border-l border-stone/50 pl-5 transition-colors hover:border-gold sm:pl-6"
    >
      ...
      <p className="mt-2 text-sm font-semibold uppercase tracking-widest text-warm-white sm:text-base">
        {stat.label}
      </p>
...
export default function RecordSection({ stats }: RecordSectionProps) {
  return (
    <section id="record" className="border-t border-stone/30 bg-charcoal">
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 sm:py-28 lg:px-16 lg:py-36">
        <div className="mb-14 sm:mb-20">
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-warm-muted sm:text-lg">
            Promises made. Promises kept. Here&apos;s where things stand — tracked
            openly, no spin.
          </p>
        </div>
